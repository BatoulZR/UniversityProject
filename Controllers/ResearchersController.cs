...
namespace SeniorProject.Controllers
{
    public class ResearchersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,reseacherName,tasks")] Researcher researcher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,reseacherName,tasks")] Researcher researcher)
        {
            if (id != researcher.ID)
            {
                return NotFound();
